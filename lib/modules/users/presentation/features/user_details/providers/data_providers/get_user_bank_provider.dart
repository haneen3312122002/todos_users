...
import 'package:notes_tasks/modules/users/api/get_user_bank_api/get_user_bank_api_service.dart';
import 'package:notes_tasks/modules/users/data/datasources/get_user_bank_remote_datasource.dart';
import 'package:notes_tasks/modules/users/data/repositories/get_user_bank_repo_impl.dart';
import 'package:notes_tasks/modules/users/domain/repositories/get_user_bank_repo.dart';
import 'package:notes_tasks/modules/users/domain/usecases/get_user_bank_usecase.dart';
