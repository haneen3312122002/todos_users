...
import 'package:notes_tasks/modules/users/api/get_user_full_api/get_user_full_api_service.dart';
import 'package:notes_tasks/modules/users/data/datasources/get_user_full_remote_datasource.dart';
import 'package:notes_tasks/modules/users/data/repositories/get_user_full_repo_impl.dart';
import 'package:notes_tasks/modules/users/domain/repositories/get_user_full_repo.dart';
import 'package:notes_tasks/modules/users/domain/usecases/get_user_full_usecase.dart';
